...
CGFloat const XYAlertViewPaddingWidth = 10.0;
CGFloat const XYAlertViewPaddingHeight = 8.0;
CGFloat const XYAlertViewButtonImageOffsetFromTitle = 8.0;

#pragma mark - Implementation

@implementation XYAlertViewHelper
...
+ (BOOL)isCancelButtonSeparate:(XYAlertView *)alertView {
    return alertView.style == XYAlertViewStyleActionSheet && alertView.cancelButtonOffsetY != NSNotFound && alertView.cancelButtonOffsetY > 0.0 && ![self isPadAndNotForce:alertView];
}
