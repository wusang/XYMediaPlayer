...
NSString * _Nonnull const XYAlertViewWillShowNotification = @"XYAlertViewWillShowNotification";
NSString * _Nonnull const XYAlertViewDidShowNotification  = @"XYAlertViewDidShowNotification";

NSString * _Nonnull const XYAlertViewWillDismissNotification = @"XYAlertViewWillDismissNotification";
NSString * _Nonnull const XYAlertViewDidDismissNotification  = @"XYAlertViewDidDismissNotification";

NSString * _Nonnull const XYAlertViewActionNotification      = @"XYAlertViewActionNotification";
NSString * _Nonnull const XYAlertViewCancelNotification      = @"XYAlertViewCancelNotification";
NSString * _Nonnull const XYAlertViewDestructiveNotification = @"XYAlertViewDestructiveNotification";

NSString * _Nonnull const XYAlertViewDidDismissAfterActionNotification      = @"XYAlertViewDidDismissAfterActionNotification";
NSString * _Nonnull const XYAlertViewDidDismissAfterCancelNotification      = @"XYAlertViewDidDismissAfterCancelNotification";
NSString * _Nonnull const XYAlertViewDidDismissAfterDestructiveNotification = @"XYAlertViewDidDismissAfterDestructiveNotification";

NSString * _Nonnull const XYAlertViewShowAnimationsNotification    = @"XYAlertViewShowAnimationsNotification";
NSString * _Nonnull const XYAlertViewDismissAnimationsNotification = @"XYAlertViewDismissAnimationsNotification";

NSString * _Nonnull const kXYAlertViewAnimationDuration = @"duration";

#pragma mark - Types

typedef enum {
    XYAlertViewTypeDefault           = 0,
    XYAlertViewTypeActivityIndicator = 1,
    XYAlertViewTypeProgressView      = 2,
    XYAlertViewTypeTextFields        = 3
}
XYAlertViewType;

#pragma mark - Interface

@interface XYAlertView () <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, UIGestureRecognizerDelegate>

@property (readwrite) BOOL             showing;
@property (readwrite) XYAlertViewStyle style;
...
@property (strong, nonatomic) XYAlertViewWindow *window;

@property (strong, nonatomic) UIView *view;

@property (strong, nonatomic) XYAlertViewController *viewController;

@property (strong, nonatomic) UIVisualEffectView *backgroundView;

@property (strong, nonatomic) XYAlertViewShadowView *shadowView;
@property (strong, nonatomic) XYAlertViewShadowView *shadowCancelView;
...
@property (strong, nonatomic) XYAlertViewButton *destructiveButton;
@property (strong, nonatomic) XYAlertViewButton *cancelButton;
@property (strong, nonatomic) XYAlertViewButton *firstButton;
@property (strong, nonatomic) XYAlertViewButton *secondButton;
@property (strong, nonatomic) XYAlertViewButton *thirdButton;
...
@property (assign, nonatomic) XYAlertViewType type;
...
@property (strong, nonatomic) XYAlertViewCell *heightCell;

@property (assign, nonatomic) NSUInteger numberOfTextFields;

@property (copy, nonatomic) XYAlertViewTextFieldsSetupHandler textFieldsSetupHandler;
...
- (nonnull instancetype)initWithActivityIndicatorAndTitle:(nullable NSString *)title
    ...
    if (self) {
        self.style = style;
        self.type = XYAlertViewTypeActivityIndicator;
        self.title = title;
        self.message = message;
        self.buttonTitles = buttonTitles.mutableCopy;
        self.cancelButtonTitle = cancelButtonTitle;
...
- (nonnull instancetype)initWithProgressViewAndTitle:(nullable NSString *)title
    ...
    if (self) {
        self.style = style;
        self.type = XYAlertViewTypeProgressView;
        self.title = title;
        self.message = message;
        self.buttonTitles = buttonTitles.mutableCopy;
        self.cancelButtonTitle = cancelButtonTitle;
...
- (nonnull instancetype)initWithTextFieldsAndTitle:(nullable NSString *)title
    ...
    self = [super init];
    if (self) {
        self.style = XYAlertViewStyleAlert;
        self.type = XYAlertViewTypeTextFields;
        self.title = title;
        self.message = message;
...
- (nonnull instancetype)initAsAppearance {
    self = [super init];
    if (self) {
        _heightCell = [[XYAlertViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];

        // -----

        _windowLevel = XYAlertViewWindowLevelAboveStatusBar;
        ...
        _layerCornerRadius = XYAlertViewHelper.systemVersion < 9.0 ? 6.0 : 12.0;
        ...
        _buttonsEnabled = YES;
        _buttonsIconPosition = XYAlertViewButtonIconPositionLeft;
        ...
        _cancelButtonIconPosition = XYAlertViewButtonIconPositionLeft;
        ...
        _destructiveButtonIconPosition = XYAlertViewButtonIconPositionLeft;
...
- (void)setupDefaults {
    ...
    XYAlertView *appearance = [XYAlertView appearance];
    ...
    if (appearance.isUserCancelOnTouch) {
        ...
        _cancelOnTouch = self.type != XYAlertViewTypeActivityIndicator && self.type != XYAlertViewTypeProgressView && self.type != XYAlertViewTypeTextFields;
    }
    ...
    if (appearance.isUserButtonsHeight) {
        ...
        _buttonsHeight = (self.style == XYAlertViewStyleAlert || XYAlertViewHelper.systemVersion < 9.0) ? 44.0 : 56.0;
    }
    ...
    if (appearance.isUserTitleTextColor) {
        ...
        _titleTextColor = self.style == XYAlertViewStyleAlert ? UIColor.blackColor : UIColor.grayColor;
    }
    ...
    if (appearance.isUserTitleFont) {
        ...
        _titleFont = [UIFont boldSystemFontOfSize:self.style == XYAlertViewStyleAlert ? 18.0 : 14.0];
    }
    ...
    if (appearance.isUserMessageTextColor) {
        ...
        _messageTextColor = self.style == XYAlertViewStyleAlert ? UIColor.blackColor : UIColor.grayColor;
    }
...
//    [self.backgroundView addGestureRecognizer:tapGesture];
    ...
    self.viewController = [[XYAlertViewController alloc] initWithAlertView:self view:self.view];

    self.window = [[XYAlertViewWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
...
+ (void)load {
    ...
    dispatch_once(&token, ^{
        [[XYAlertViewWindowsObserver sharedInstance] startObserving];
    });
}
...
#if DEBUG && XY_ALERT_VIEW_DEBUG
    NSLog(@"XYAlertView DEALLOCATED");
#endif
}
...
+ (instancetype)sharedAlertViewForAppearance {
    static XYAlertView *alertView;
    static dispatch_once_t onceToken;

    dispatch_once(&onceToken, ^{
        alertView = [[XYAlertView alloc] initAsAppearance];
    });
...
- (BOOL)textFieldShouldReturn:(XYAlertViewTextField *)textField {
    if (textField.returnKeyType == UIReturnKeyNext) {
        if (self.textFieldsArray.count > textField.tag + 1) {
            XYAlertViewTextField *nextTextField = self.textFieldsArray[textField.tag + 1];
...
- (void)setProgress:(float)progress {
    if (self.type != XYAlertViewTypeProgressView) return;
...
- (void)setProgressLabelText:(nullable NSString *)progressLabelText {
    if (self.type != XYAlertViewTypeProgressView && self.type != XYAlertViewTypeActivityIndicator) return;
...
- (void)setCancelButtonEnabled:(BOOL)cancelButtonEnabled {
    ...
    if (self.cancelButtonTitle) {
        if (self.tableView) {
            XYAlertViewCell *cell = (XYAlertViewCell *)[self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:(self.buttonTitles.count - 1) inSection:0]];
...
- (void)setDestructiveButtonEnabled:(BOOL)destructiveButtonEnabled {
    ...
    if (self.destructiveButtonTitle) {
        if (self.tableView) {
            XYAlertViewCell *cell = (XYAlertViewCell *)[self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]];
...
- (CGFloat)width {
    CGSize size = XYAlertViewHelper.appWindow.bounds.size;
    ...
    if (self.style == XYAlertViewStyleAlert || [XYAlertViewHelper isPadAndNotForce:self]) {
        return 280.0; // 320.0 - (20.0 * 2.0)
    }

    if (XYAlertViewHelper.isPad) {
...
- (void)setDelegate:(id<XYAlertViewDelegate>)delegate {
    _delegate = delegate;
...
- (void)setButtonEnabled:(BOOL)enabled atIndex:(NSUInteger)index {
    ...
    if (self.tableView) {
        ...
        XYAlertViewCell *cell = (XYAlertViewCell *)[self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:index inSection:0]];
...
- (void)setButtonPropertiesAtIndex:(NSUInteger)index
                           handler:(void(^ _Nonnull)(XYAlertViewButtonProperties * _Nonnull properties))handler {
    ...
    XYAlertViewButtonProperties *properties = self.buttonsPropertiesDictionary[@(index)];

    if (!properties) {
        properties = [XYAlertViewButtonProperties new];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    XYAlertViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (void)configCell:(XYAlertViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.destructiveButtonTitle && indexPath.row == 0) {
    ...
    else if (self.cancelButtonTitle && ![XYAlertViewHelper isCancelButtonSeparate:self] && indexPath.row == self.buttonTitles.count - 1) {
        ...
        XYAlertViewButtonProperties *properties = nil;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else if (self.cancelButtonTitle && indexPath.row == self.buttonTitles.count - 1 && ![XYAlertViewHelper isCancelButtonSeparate:self]) {
        [self cancelAction:nil];
    }
    else {
...
- (void)showAnimated:(BOOL)animated hidden:(BOOL)hidden completionHandler:(XYAlertViewCompletionHandler)completionHandler {
    if (!self.isValid || self.isShowing) return;

    self.window.windowLevel = UIWindowLevelStatusBar + (self.windowLevel == XYAlertViewWindowLevelAboveStatusBar ? 1 : -1);
    ...
    UIWindow *keyWindow = XYAlertViewHelper.keyWindow;

    [keyWindow endEditing:YES];

    if (!hidden && keyWindow != XYAlertViewHelper.appWindow) {
    ...
    if (hidden) {
        ...
        if ([XYAlertViewHelper isCancelButtonSeparate:self]) {
    ...
    if (animated) {
        [XYAlertViewHelper
         ...
         animations:^(void) {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewShowAnimationsNotification
                                                                 object:self
                                                               userInfo:@{kXYAlertViewAnimationDuration: @(self.animationDuration)}];
...
- (void)showAnimations {
    ...
    if ([XYAlertViewHelper isCancelButtonSeparate:self] && self.cancelButton) {
...
- (void)showComplete {
    if (self.type == XYAlertViewTypeTextFields && self.textFieldsArray.count) {
    ...
    if (animated) {
        [XYAlertViewHelper
         ...
         animations:^(void) {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewDismissAnimationsNotification
                                                                 object:self
                                                               userInfo:@{kXYAlertViewAnimationDuration: @(self.animationDuration)}];
...
- (void)transitionToAlertView:(nonnull XYAlertView *)alertView completionHandler:(XYAlertViewCompletionHandler)completionHandler {
    ...
    [alertView showAnimated:NO
          ...
          completionHandler:^(void) {
              ...
              BOOL cancelButtonSelf = [XYAlertViewHelper isCancelButtonSeparate:self] && self.cancelButtonTitle;
              BOOL cancelButtonNext = [XYAlertViewHelper isCancelButtonSeparate:alertView] && alertView.cancelButtonTitle;
...
- (void)transitionToAlertView:(XYAlertView *)alertView {
...
- (void)subviewsValidateWithSize:(CGSize)size {
    ...
    if (!self.isExists) {
        ...
        self.shadowView = [XYAlertViewShadowView new];
        ...
        if (self.title) {
            ...
            CGSize titleLabelSize = [self.titleLabel sizeThatFits:CGSizeMake(width - XYAlertViewPaddingWidth * 2.0, CGFLOAT_MAX)];
            CGRect titleLabelFrame = CGRectMake(XYAlertViewPaddingWidth, self.innerMarginHeight, width - XYAlertViewPaddingWidth * 2.0, titleLabelSize.height);
        ...
        if (self.message) {
            ...
            else if (self.style == XYAlertViewStyleActionSheet) {
                offsetY -= self.innerMarginHeight / 3.0;
            }

            CGSize messageLabelSize = [self.messageLabel sizeThatFits:CGSizeMake(width - XYAlertViewPaddingWidth * 2.0, CGFLOAT_MAX)];
            CGRect messageLabelFrame = CGRectMake(XYAlertViewPaddingWidth, offsetY + self.innerMarginHeight / 2.0, width-XYAlertViewPaddingWidth * 2.0, messageLabelSize.height);
        ...
        if (self.innerView) {
        ...
        else if (self.type == XYAlertViewTypeActivityIndicator || self.type == XYAlertViewTypeProgressView) {
            if (self.type == XYAlertViewTypeActivityIndicator) {
            ...
            else if (self.type == XYAlertViewTypeProgressView) {
                ...
                CGRect progressViewFrame = CGRectMake(XYAlertViewPaddingWidth,
                                                      offsetY + self.innerMarginHeight,
                                                      width - (XYAlertViewPaddingWidth * 2.0),
            ...
            if (self.progressLabelText) {
                ...
                CGRect progressLabelFrame = CGRectMake(XYAlertViewPaddingWidth,
                                                       offsetY + (self.innerMarginHeight / 2.0),
                                                       width - (XYAlertViewPaddingWidth * 2.0),
        ...
        else if (self.type == XYAlertViewTypeTextFields) {
            ...
            for (NSUInteger i = 0; i < self.numberOfTextFields; i++) {
                ...
                XYAlertViewTextField *textField = [XYAlertViewTextField new];
        ...
        if ([XYAlertViewHelper isCancelButtonSeparate:self] && self.cancelButtonTitle) {
            self.shadowCancelView = [XYAlertViewShadowView new];
        ...
        if (self.cancelButtonTitle && ![XYAlertViewHelper isCancelButtonSeparate:self]) {
            numberOfButtons++;
        }
        ...
        if (numberOfButtons) {
            if (!self.isOneRowOneButton &&
                ((self.style == XYAlertViewStyleAlert && numberOfButtons < 4) ||
                 (self.style == XYAlertViewStyleActionSheet && numberOfButtons == 1))) {
                    ...
                    if (self.destructiveButtonTitle && !showTable) {
                        self.destructiveButton = [XYAlertViewButton new];
                        ...
                        if (self.destructiveButton.imageView.image && self.destructiveButton.titleLabel.text.length) {
                            self.destructiveButton.titleEdgeInsets = UIEdgeInsetsMake(0.0,
                                                                                      XYAlertViewButtonImageOffsetFromTitle / 2.0,
                                                                                      0.0,
                                                                                      XYAlertViewButtonImageOffsetFromTitle / 2.0);
                        }
                    ...
                    if (self.cancelButtonTitle && ![XYAlertViewHelper isCancelButtonSeparate:self] && !showTable) {
                        [self cancelButtonInit];
                    ...
                    if (self.buttonTitles.count > 0 && !showTable) {
                        ...
                        self.firstButton = [XYAlertViewButton new];
                        ...
                        if (self.buttonTitles.count > 1 && !showTable) {
                            ...
                            self.secondButton = [XYAlertViewButton new];
                            ...
                            if (self.buttonTitles.count > 2 && !showTable) {
                                ...
                                self.thirdButton = [XYAlertViewButton new];
                    ...
                    if (!showTable) {
                        ...
                        if (self.cancelButton && ![XYAlertViewHelper isCancelButtonSeparate:self]) {
                        ...
                        if (offsetY) {
                            ...
                            CGRect separatorHorizontalViewFrame = CGRectMake(0.0, offsetY + self.innerMarginHeight, width, XYAlertViewHelper.separatorHeight);
                        ...
                        if (secondButton) {
                            secondButtonFrame = CGRectMake(CGRectGetMinX(firstButtonFrame) + CGRectGetWidth(firstButtonFrame) + XYAlertViewHelper.separatorHeight,
                                                           offsetY,
                                                           (width / numberOfButtons) - XYAlertViewHelper.separatorHeight,
                                                           self.buttonsHeight);
                            ...
                            if (thirdButton) {
                                thirdButtonFrame = CGRectMake(CGRectGetMinX(secondButtonFrame) + CGRectGetWidth(secondButtonFrame) + XYAlertViewHelper.separatorHeight,
                                                              offsetY,
                                                              (width / numberOfButtons) - XYAlertViewHelper.separatorHeight,
                                                              self.buttonsHeight);
            ...
            if (showTable) {
                ...
                [self.tableView registerClass:[XYAlertViewCell class] forCellReuseIdentifier:@"cell"];
                ...
                if (!offsetY) {
                    ...
                    CGRect separatorTitleViewFrame = CGRectMake(0.0, 0.0, width, XYAlertViewHelper.separatorHeight);
...
- (void)layoutValidateWithSize:(CGSize)size {
    ...
    if (self.windowLevel == XYAlertViewWindowLevelBelowStatusBar) {
        heightMax -= XYAlertViewHelper.statusBarHeight;
    }
    ...
    if (self.style == XYAlertViewStyleAlert || [XYAlertViewHelper isPadAndNotForce:self]) {
        ...
        if (self.windowLevel == XYAlertViewWindowLevelBelowStatusBar) {
            scrollViewFrame.origin.y += XYAlertViewHelper.statusBarHeight / 2.0;
        }
    ...
    if (self.style == XYAlertViewStyleActionSheet && ![XYAlertViewHelper isPadAndNotForce:self]) {
...
- (void)cancelButtonInit {
    self.cancelButton = [XYAlertViewButton new];
...
- (void)cancelAction:(id)sender {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewCancelNotification object:self userInfo:nil];
    ...
    if (self.dismissOnAction) {
        [self dismissAnimated:self.shouldDismissAnimated completionHandler:^{
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewDidDismissAfterCancelNotification object:self userInfo:nil];
        }];
    }
}
...
- (void)destructiveAction:(id)sender {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewDestructiveNotification object:self userInfo:nil];
    ...
    if (self.dismissOnAction) {
        [self dismissAnimated:self.shouldDismissAnimated completionHandler:^{
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewDidDismissAfterDestructiveNotification object:self userInfo:nil];
        }];
    }
}
...
- (void)actionActionAtIndex:(NSUInteger)index title:(NSString *)title {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewActionNotification
                                                        object:self
    ...
    if (self.dismissOnAction) {
        [self dismissAnimated:self.shouldDismissAnimated completionHandler:^{
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewDidDismissAfterActionNotification
                                                                object:self
                                                              userInfo:@{@"title": title,
                                                                         @"index": @(index)}];
        }];
...
- (void)willShowCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewWillShowNotification object:self userInfo:nil];
}
...
- (void)didShowCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewDidShowNotification object:self userInfo:nil];
}
...
- (void)willDismissCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewWillDismissNotification object:self userInfo:nil];
}
...
- (void)didDismissCallback {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XYAlertViewDidDismissNotification object:self userInfo:nil];
}

#pragma mark - Helpers

- (BOOL)isAlertViewValid:(XYAlertView *)alertView {
    NSAssert(alertView.isInitialized, @"You need to use one of \"- initWith...\" or \"+ alertViewWith...\" methods to initialize XYAlertView");
...
- (CGFloat)innerMarginHeight {
    return self.style == XYAlertViewStyleAlert ? 16.0 : 12.0;
}
...
@implementation XYAlertView (Deprecated)
