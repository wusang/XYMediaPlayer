...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    XYProgressLayer *layer = (XYProgressLayer *)self.layer;
    layer.progress = _progress;
    [(XYProgressLayer *)self.layer setProgressWithAnimated:animated];
}
