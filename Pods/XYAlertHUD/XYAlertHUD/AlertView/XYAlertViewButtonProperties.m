...
@interface XYAlertViewButtonProperties ()
...
@implementation XYAlertViewButtonProperties
...
- (void)setIconPosition:(XYAlertViewButtonIconPosition)iconPosition {
